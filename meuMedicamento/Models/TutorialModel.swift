...
let tabs = [
    Page(image: "Logo", title: "Organize seus medicamentos", text: "meuMedicamento tem como objetivo ajudar pessoas a controlar seus medicamentos, por meio dele o usuário consegue receber notificações, alertas se o medicamento estiver acabando e é preciso comprar mais e visualizar um mapa com todas as farmácias e hospitais próximos da sua localização."),
